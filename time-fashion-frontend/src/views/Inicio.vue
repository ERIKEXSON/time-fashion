<template>
    ...
    <v-layout row wrap>
      <v-flex xs6 sm6 md>
        <v-img :src="mujeres" class="img-responsive" @click="clickPush('/mujer')"></v-img>
      </v-flex>
      <v-flex xs6 sm6 md>
        <v-img :src="hombres" class="img-responsive" @click="clickPush('/hombre')"></v-img>
      </v-flex>
      </v-layout>

      <v-layout row wrap>
      <v-flex xs6 sm4 md>
        <v-img :src="tanks" class="img-responsive2" @click="clickPush('/shorts-y-faldas-mujer')"></v-img>
      </v-flex>
      <v-flex xs6 sm4 md>
      ...
      <v-flex xs6 sm4 md>
        <v-img :src="shorts" class="img-responsive2" @click="clickPush('/tops-mujer')"></v-img>
      </v-flex>
      <v-flex xs6 sm4 md>
