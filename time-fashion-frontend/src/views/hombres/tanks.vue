<template>
    <v-container grid-list-md text-xs-center>
      <v-layout row wrap>
        ...
        <v-flex xs6 sm4 md>
            <v-card-text><img src="@/assets/hombre/tanks/azuloscuro.jpg" class="img-responsive" alt=""></v-card-text>
            <v-card-title class="precio"> Vestido Mostaza Texto<v-spacer></v-spacer> $30.000</v-card-title>
        </v-flex>

        <v-flex xs6 sm4 md>
            <v-card-text><img src="@/assets/hombre/tanks/blanco.jpg" class="img-responsive" alt=""></v-card-text>
