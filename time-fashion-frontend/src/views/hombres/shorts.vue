<template>
    <v-container grid-list-md text-xs-center>
      <v-layout row wrap>
        ...
        <v-flex xs6 sm4 md>
            <v-card-text><img src="@/assets/hombre/shorts/mostaza.jpg" class="img-responsive" alt=""></v-card-text>
            <v-card-title class="precio"> Top Rosado Texto <v-spacer></v-spacer> $24.000</v-card-title>
        </v-flex>

        <v-flex xs6 sm4 md>
            <v-card-text><img src="@/assets/hombre/shorts/negro.jpg" class="img-responsive" alt=""></v-card-text>
            <v-card-title class="precio"> Top Azul Oscuro Flores<v-spacer></v-spacer> $25.000</v-card-title>
        </v-flex>

        <v-flex xs6 sm4 md>
            <v-card-text><img src="@/assets/hombre/shorts/destroyer.jpg" class="img-responsive" alt=""></v-card-text>
            <v-card-title class="precio"> Vestido Negro Cuadros<v-spacer></v-spacer> $38.000</v-card-title>
        </v-flex>

        <v-flex xs6 sm4 md>
            <v-card-text><img src= "@/assets/hombre/shorts/negro1.jpg" class="img-responsive" alt=""></v-card-text>
